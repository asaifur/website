...
<script>
    $(document).ready(function() {
        ...
        tableTransaksi = $('#myTable').DataTable({
            ...
            ajax: {
                url: "<?= base_url('Dashboard/view_post'); ?>",
                type: "POST",
                data: function(d) {
        ...
        $('#myTable').on('click', '.btn-update', function(e) {
            ...
            $.ajax({
                url: "<?= base_url('Dashboard/addTambahPost/update/'); ?>" + id,
                type: "GET",
        ...
        $('#myTable').on('click', '.btn-delete', function(e) {
            ...
            $.ajax({
                url: "<?= base_url('Dashboard/addTambahPost/delete/'); ?>" + id,
                type: "GET",
        ...
        $('#btnTambahContent').on('click', function(e) {
            ...
            $.ajax({
                url: "<?= base_url('Dashboard/addTambahPost/insert'); ?>",
                type: "GET",
                beforeSend: function() {
                    $('#modalContent').modal('show');
                    $('#isiModalContent').html(`
