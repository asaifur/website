    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-striped table-valign-middle">
            ...
            <tbody>
                ...
                // 2. Ambil data jumlah job dari object $result 
                // (Pastikan controller/model Anda sudah menghasilkan alias ini, contoh: total_qc1 dan total_qc2)
                $jml_qc1 = isset($result->total_qc1) ? $result->total_qc1 : 0;
                $jml_qc2 = isset($result->total_qc2) ? $result->total_qc2 : 0;
