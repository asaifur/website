...
<script>
    $(document).ready(function() {
        ...
        $('#myTable').on('click', '.btn-update-qc-email', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            $.ajax({
                url: "<?= base_url('Dashboard/form_update_qc/update_qc_email'); ?>",
                type: "POST",
                data: {
                    id: id
                },
        ...
        $(document).ready(function() {
            tableTransaksi = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "<?= base_url('Dashboard/view_daftar_qc_2'); ?>",
                    type: "POST",
                    data: function(d) {
...
<script>
    ...
    $('#myTable').on('click', '.update-qc', function(e) {
        ...
        Swal.fire({
            title: 'Konfirmasi QC',
            text: 'Apakah Anda yakin ingin MENYETUJUI QC Foto P3H ini?',
            icon: 'question',
            showCancelButton: true,
            confirmButtonText: 'Ya, QC',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?= base_url('Dashboard/update_qc_foto'); ?>",
                    type: "POST",
                    data: {
                        id: id,
                        qc_status: 1
